...
object session {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(76); 
  ...
  y.add(y);System.out.println("""res2: week3.Rational = """ + $show(res$2));$skip(31); 

  val z = new Rational(1, 1);System.out.println("""z  : week3.Rational = """ + $show(z ));$skip(27); 
  val z2 = new Rational(1);System.out.println("""z2  : week3.Rational = """ + $show(z2 ))}
}
